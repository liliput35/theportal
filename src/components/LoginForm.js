        ...
        <form onSubmit={submitHandler} className={lclasss}>
            <div className="container">
                <div className="wrapper">
                    ...
                    <input type="text" name="name" id="name" placeholder="Enter Name" autoComplete="0" 
                    onChange={e => setDetails({...details, name: e.target.value})} value={details.name}/> <br />

                    <input type="password" name="password" id="password" placeholder="Enter Password"
                    onChange={e => setDetails({...details, password: e.target.value})} value={details.password}/> <br />
